...
const Billing = () => {
  return (
    ...
    >
      <div className="flex-1 justify-center flex items-center md:mr-10 mr-0 md:mt-0 mt-10 relative ">
        <img
          src={bill}
          alt="billing"
      ...
      <div className="flex-1 flex justify-center items-start flex-col">
        ...
        <div className="flex  flex-row flex-wrap sm:mt-10 mt-6">
          <img
            src={apple}
            alt="google_play"
            className="w-[128.86px] h-[42.05px] mr-5 cursor-pointer object-contain  "
          />
          <img
            src={google}
            alt="google_play"
